...
const INSTRUMENT_ENCOURAGED = ["Kuyayky"];
...
// ─── EVENTS ──────────────────────────────────────────────────────────────────
const SAMPLE_EVENTS = [
  { id: 1,  title: "Clase de Festejo · Tondero · Huaylarsh · Carnaval — Sumaj Tusuy DMV", group: "Sumaj Tusuy DMV", date: "2026-06-01", time: "7:30 PM – 9:00 PM", location: "George Mason Regional Library, 7001 Little River Tpke, Annandale, VA 22003", description: "Únete a nosotros para una clase de danza folclórica peruana. Abierta a mayores de 18 años. No se requiere experiencia previa. ¡Ven a aprender y celebrar nuestra cultura!", contact: "Beatriz Morales · 305-761-2666", registrationLink: "https://forms.gle/w5yWYUm37f7LXAgb8", host: "Sumaj Tusuy DMV", published: true },
  { id: 2,  title: "Clase de Festejo · Tondero · Huaylarsh · Carnaval — Sumaj Tusuy DMV", group: "Sumaj Tusuy DMV", date: "2026-06-17", time: "7:30 PM – 9:00 PM", location: "Thomas Jefferson Library, 7415 Arlington Blvd, Falls Church, VA 22042", description: "Únete a nosotros para una clase de danza folclórica peruana. Abierta a mayores de 18 años. No se requiere experiencia previa. ¡Ven a aprender y celebrar nuestra cultura!", contact: "Beatriz Morales · 305-761-2666", registrationLink: "https://forms.gle/w5yWYUm37f7LXAgb8", host: "Sumaj Tusuy DMV", published: true },
  { id: 3,  title: "Clase de Festejo · Tondero · Huaylarsh · Carnaval — Sumaj Tusuy DMV", group: "Sumaj Tusuy DMV", date: "2026-06-24", time: "7:30 PM – 9:00 PM", location: "Richard Byrd Library, 7250 Commerce St, Springfield, VA 22150", description: "Únete a nosotros para una clase de danza folclórica peruana. Abierta a mayores de 18 años. No se requiere experiencia previa. ¡Ven a aprender y celebrar nuestra cultura!", contact: "Beatriz Morales · 305-761-2666", registrationLink: "https://forms.gle/w5yWYUm37f7LXAgb8", host: "Sumaj Tusuy DMV", published: true },
  { id: 4,  title: "Clase de Marinera, Cajón y Danzas Peruanas — Sentimiento Peruano",          group: "Sentimiento Peruano",         date: "2026-06-05", time: "7pm Marinera Básico · 8pm Marinera Avanzado / Cajón · 9pm Danzas Folclóricas", location: "3700 S Four Mile Run, Arlington", description: "Clases de marinera, cajón y danzas folclóricas peruanas para todas las edades y niveles. Regístrate con anticipación para reservar tu lugar.", contact: "Catherine · 703-304-8322", host: "Sentimiento Peruano", published: true },
  { id: 5,  title: "Clase de Marinera, Cajón y Danzas Peruanas — Sentimiento Peruano",          group: "Sentimiento Peruano",         date: "2026-07-10", time: "7pm Marinera Básico · 8pm Marinera Avanzado / Cajón · 9pm Danzas Folclóricas", location: "3700 S Four Mile Run, Arlington", description: "Clases de marinera, cajón y danzas folclóricas peruanas para todas las edades y niveles. Regístrate con anticipación para reservar tu lugar.", contact: "Catherine · 703-304-8322", host: "Sentimiento Peruano", published: true },
  { id: 6,  title: "Clase de Caporales (Caporales Centralistas Filial USA) — Aquí Está Mi Perú", group: "Aquí Está Mi Perú", date: "2026-06-13", time: "6:00 PM", location: "Gaithersburg Elementary, 35 N Summit Ave, Gaithersburg, MD 20877", description: "Aprende la danza de los Caporales, una danza vibrante y energética originaria de Bolivia y muy popular en el Perú. Abierta a todas las edades y niveles.", contact: "Jorgeluis · 240-590-9888", host: "Aquí Está Mi Perú", published: true },
  { id: 15, title: "Clase de Caporales (Caporales Centralistas Filial USA) — Aquí Está Mi Perú", group: "Aquí Está Mi Perú", date: "2026-06-20", time: "6:00 PM", location: "Gaithersburg Elementary, 35 N Summit Ave, Gaithersburg, MD 20877", description: "Aprende la danza de los Caporales, una danza vibrante y energética originaria de Bolivia y muy popular en el Perú. Abierta a todas las edades y niveles.", contact: "Jorgeluis · 240-590-9888", host: "Aquí Está Mi Perú", published: true },
  { id: 16, title: "Clase de Caporales (Caporales Centralistas Filial USA) — Aquí Está Mi Perú", group: "Aquí Está Mi Perú", date: "2026-06-27", time: "6:00 PM", location: "Gaithersburg Elementary, 35 N Summit Ave, Gaithersburg, MD 20877", description: "Aprende la danza de los Caporales, una danza vibrante y energética originaria de Bolivia y muy popular en el Perú. Abierta a todas las edades y niveles.", contact: "Jorgeluis · 240-590-9888", host: "Aquí Está Mi Perú", published: true },
  { id: 7,  title: "Clase de Marinera — Papalca",                      group: "Papalca",                     date: "2026-06-06", time: "10:00 AM – 10:40 AM", location: "Ubicación privada — regístrate para recibirla", description: "Aprende la Marinera, el baile nacional del Perú. Una danza elegante y llena de gracia que representa nuestra identidad cultural. Abierta a todas las edades y niveles. Cupos limitados — regístrate con anticipación.", contact: "Victor · 240-839-8803", host: "Papalca", published: true },
  { id: 8,  title: "Clase de Ritmos Afro Peruanos — Perú Folclore",                group: "Perú Folclore",               date: "2026-06-09", time: "7:00 PM", location: "14301 Climbing Rose Way, Centreville, VA 20121", description: "Descubre los Ritmos Afro Peruanos en esta clase especial que celebra la rica herencia africana en la música y danza del Perú. Abierta a todos los niveles.", contact: "Andrés Arevalo · 202-500-9328", host: "Perú Folclore", published: true },
  { id: 9,  title: "Clase de Danzas de Distintas Regiones — Fraternidad Matices del Perú", group: "Fraternidad Matices del Perú", date: "2026-06-06", time: "5:00 PM", location: "Washington Square Neighborhood Park, 17800 Amity Drive, Gaithersburg, MD 20877", description: "Danzas de distintas regiones: Llamachasqui (Ayacucho), Caporales (Puno), Cuadro Amazónico (Selva). Todas las edades y niveles bienvenidos.", contact: "Maryorie · 240-477-2370", host: "Fraternidad Matices del Perú", published: true },
  { id: 13, title: "Clase de Danzas de Distintas Regiones — Fraternidad Matices del Perú", group: "Fraternidad Matices del Perú", date: "2026-06-13", time: "5:00 PM", location: "Washington Square Neighborhood Park, 17800 Amity Drive, Gaithersburg, MD 20877", description: "Danzas de distintas regiones: Llamachasqui (Ayacucho), Caporales (Puno), Cuadro Amazónico (Selva). Todas las edades y niveles bienvenidos.", contact: "Maryorie · 240-477-2370", host: "Fraternidad Matices del Perú", published: true },
  { id: 17, title: "Clase de Festejo — Percy Chinchilla", group: "Percy Chinchilla", date: "2026-06-13", time: "10:30 AM – 12:30 PM", location: "Thomas Jefferson Library, 7415 Arlington Blvd, Falls Church, VA 22042", description: "Aprende el Festejo, una de las danzas afroperuanas más vibrantes y alegres del Perú. Una experiencia llena de ritmo, energía y cultura. Abierta a todas las edades y niveles.", contact: "Percy · 240-963-8503", host: "Percy Chinchilla", published: true },
  { id: 10, title: "Clase de Cajón Peruano — Percy Chinchilla", instrumentEncouraged: true,,             group: "Percy Chinchilla",            date: "2026-06-06", time: "11:00 AM – 12:30 PM", location: "Calletana's Peruvian Chicken & Cuisine, 4300 Chantilly Shopping Center, Chantilly, VA 20151", description: "Aprende a tocar el cajón peruano, instrumento icónico de la música afroperuana. Clase práctica para principiantes y entusiastas de la percusión. 🥁 Se recomienda traer tu cajón si tienes uno. 🔜 Próximamente: clase de danza afroperuana abierta a todas las edades.", contact: "Percy · 240-963-8503", host: "Percy Chinchilla", published: true },
  { id: 11, title: "🎶 ¡Coming Soon! — Chicha Morada",                group: "Chicha Morada",               date: "", time: "", location: "Inca Social, 1776 Wilson Blvd, Arlington, VA 22209", description: "¡Próximamente! Estamos preparando algo especial en Inca Social. Mantente pendiente.", contact: "chichamoradadc@gmail.com", contact: "chichamoradadc@gmail.com", host: "Chicha Morada", published: true },
  { id: 12, title: "Masterclass de Música de Cámara Andina — Kuyayky", instrumentEncouraged: true,,                      group: "Kuyayky",                     date: "2026-06-06", time: "4:00 PM – 6:00 PM", location: "George Mason Regional Library, 7001 Little River Turnpike, Annandale, VA 22003", description: "Sumérgete en la música de cámara andina en esta masterclass única. Explora los sonidos, ritmos e instrumentos tradicionales de los Andes peruanos. 🎵 Se recomienda traer tu instrumento — no es obligatorio pero sí muy alentado.", contact: "Jose Hurtado · (786) 228-6189", host: "Kuyayky", published: true },
];
      ...
      {events.map(ev => {
        ...
        return (
          ...
          >
            ...
            {ev.description && <p style={{ color:"#a07850", fontSize:"0.8rem", margin:"0 0 0.4rem", lineHeight:1.5 }}>{ev.description.slice(0,80)}{ev.description.length>80?"…":""}</p>}
            {ev.contact && (
              <div style={{ fontSize:"0.78rem", color:P.brown, fontWeight:600, marginTop:"0.3rem" }}>
                📞 {ev.contact}
              </div>
            )}
            {ev.registrationLink && (
              <a href={ev.registrationLink} target="_blank" rel="noopener noreferrer"
                style={{ display:"inline-flex", alignItems:"center", gap:"0.3rem", marginTop:"0.5rem", background:`${P.red}12`, border:`1px solid ${P.red}40`, borderRadius:"0.5rem", padding:"0.4rem 0.75rem", fontSize:"0.78rem", color:P.red, fontWeight:700, textDecoration:"none" }}>
                📝 Regístrate aquí
              </a>
            )}
            ...
            {/* Instrument badge */}
            {(INSTRUMENT_ENCOURAGED.includes(ev.group) || ev.instrumentEncouraged) && (
...
function CalendarView({ events, onView }) {
  ...
  const [viewMonth, setViewMonth] = useState(5); // Start at June
  ...
  return (
    <div>
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:"1.25rem" }}>
        <button onClick={() => { if(!(viewMonth === 5 && viewYear === 2026)) { if(viewMonth===0){setViewMonth(11);setViewYear(y=>y-1);}else setViewMonth(m=>m-1); } }}
          style={{ background: viewMonth===5 && viewYear===2026 ? "rgba(255,255,255,0.03)" : P.bgMid, border:`1px solid ${P.border}`, borderRadius:"0.5rem", color: viewMonth===5 && viewYear===2026 ? P.border : P.gold, padding:"0.4rem 0.85rem", cursor: viewMonth===5 && viewYear===2026 ? "default" : "pointer", fontSize:"1.1rem" }}>‹</button>
        <h2 style={{ fontFamily:"'Playfair Display', serif", color:P.gold, fontSize:"1.3rem", margin:0 }}>{MONTHS[viewMonth]} {viewYear}</h2>
        <button onClick={() => { if(!(viewMonth === 6 && viewYear === 2026)) { if(viewMonth===11){setViewMonth(0);setViewYear(y=>y+1);}else setViewMonth(m=>m+1); } }}
          style={{ background: viewMonth===6 && viewYear===2026 ? "rgba(255,255,255,0.03)" : P.bgMid, border:`1px solid ${P.border}`, borderRadius:"0.5rem", color: viewMonth===6 && viewYear===2026 ? P.border : P.gold, padding:"0.4rem 0.85rem", cursor: viewMonth===6 && viewYear===2026 ? "default" : "pointer", fontSize:"1.1rem" }}>›</button>
      </div>
            ...
            return (
              <div key={ev.id} onClick={() => onView(ev)} style={{ display:"flex", alignItems:"center", gap:"0.75rem", background:"#fff", border:`1px solid ${color}40`, borderLeft:`4px solid ${color}`, borderRadius:"0.5rem", padding:"0.6rem 0.85rem", cursor:"pointer" }}>
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  ...
                  <div style={{ fontSize:"0.75rem", color:P.brown, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
                    {ev.title.includes(" — ") ? ev.title.split(" — ")[0] : ev.title}
                  </div>
                  <div style={{ fontSize:"0.72rem", color:P.muted }}>
                    📍 {ev.location ? ev.location.split(",").slice(-2).join(",").trim() : ""}
                    {ev.time ? " · " + ev.time : ""}
                  </div>
                  {REQUIRES_REGISTRATION.includes(ev.group) && ev.contact && (
                    <div style={{ fontSize:"0.72rem", color:P.red, fontWeight:700, marginTop:"0.15rem" }}>
                      📋 Inscripciones: {ev.contact}
                    </div>
                  )}
                  {ev.contact && !REQUIRES_REGISTRATION.includes(ev.group) && (
                    <div style={{ fontSize:"0.72rem", color:P.muted, marginTop:"0.15rem" }}>
                      📞 {ev.contact}
                    </div>
                  )}
                  {ev.registrationLink && (
                    <a href={ev.registrationLink} target="_blank" rel="noopener noreferrer"
                      style={{ fontSize:"0.72rem", color:P.red, fontWeight:700, textDecoration:"none", marginTop:"0.15rem", display:"inline-block" }}>
                      📝 Regístrate aquí →
                    </a>
                  )}
                </div>
          ...
          <div>
            ...
            {selected.registrationLink && (
              <a href={selected.registrationLink} target="_blank" rel="noopener noreferrer"
                style={{ display:"inline-flex", alignItems:"center", gap:"0.5rem", marginTop:"1rem", background:`${P.red}12`, border:`1px solid ${P.red}40`, borderRadius:"0.5rem", padding:"0.6rem 1rem", fontSize:"0.88rem", color:P.red, fontWeight:700, textDecoration:"none" }}>
                📝 Regístrate aquí
              </a>
            )}
