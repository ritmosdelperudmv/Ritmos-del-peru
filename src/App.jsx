...
const SAMPLE_EVENTS = [
  ...
  { id: 3,  title: "Clase de Festejo · Tondero · Huaylarsh · Carnaval — Sumaj Tusuy DMV", group: "Sumaj Tusuy DMV", date: "2026-06-24", time: "7:00 PM – 8:15 PM", location: "Richard Byrd Library, 7250 Commerce St, Springfield, VA 22150", description: "Únete a nosotros para una clase de danza folclórica peruana. Abierta a mayores de 18 años. No se requiere experiencia previa. ¡Ven a aprender y celebrar nuestra cultura!", contact: "Beatriz Morales · 305-761-2666", registrationLink: "https://forms.gle/w5yWYUm37f7LXAgb8", host: "Sumaj Tusuy DMV", published: true },
  ...
  { id: 15, title: "Clase de Caporales (Caporales Centralistas Filial USA) — Aquí Está Mi Perú", group: "Aquí Está Mi Perú", date: "2026-06-19", time: "7:00 PM", location: "Gaithersburg Elementary, 35 N Summit Ave, Gaithersburg, MD 20877", description: "Aprende la danza de los Caporales, una danza vibrante y energética muy popular en el Perú. Abierta a todas las edades y niveles.", contact: "Jorgeluis · 240-590-9888", host: "Aquí Está Mi Perú", published: true },
  ...
  { id: 11, title: "Noche de Chicha Morada en DC", group: "Chicha Morada", date: "2026-06-24", time: "7:30 PM – Lamont Plaza | 9:30 PM – Marx Cafe (al lado)", location: "Lamont Plaza, 3258 Mt Pleasant St NW, Washington, DC 20010", description: "¡Una noche entera de Chicha Morada en DC! 🎶 7:30–8:30 PM: Presentación en vivo en Lamont Plaza (3258 Mt Pleasant St NW). 🎤 9:30 PM: Open Mic en Marx Cafe (3203 Mt Pleasant St NW) — justo al lado de Lamont Plaza. ¡La noche no para!", contact: "chichamoradadc@gmail.com", host: "Chicha Morada", published: true },
          ...
          >
            ...
            {ev.contact && (
              <div style={{ fontSize:"0.78rem", color:P.brown, fontWeight:600, marginTop:"0.3rem" }}>
                {ev.contact.includes("@") ? "✉️" : "📞"} {ev.contact}
              </div>
            )}
            {ev.registrationLink && (
